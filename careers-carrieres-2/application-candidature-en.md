...
<nav class="gc-subway gc-subway-index">
  ...
  <dl>
    ...
    <dt>
      <a href="application-candidature-3-en.html">Submit the required forms and documents</a>
    </dt>
    <dd>Complete and submit forms through the Online Security Portal.</dd>
    <dt>
      <a href="application-candidature-4-en.html">Complete a suitability interview</a>
    </dt>
