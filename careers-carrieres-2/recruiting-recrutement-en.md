...
var EVENTS = [
    ...
    { title: 'National Ask-a-Recruiter Session',            city: '',                province: '',                          tz: 'ET', eventType: 'Ask-a-recruiter',                       jobType: 'Police officer',                      format: 'Virtual',   language: 'English and French', time: '1:00 p.m.',  date: '2026-07-16', cancelled: false },
    ...
    { title: 'Online Entrance Assessment Workshop',         city: '',                province: '',                          tz: 'ET', eventType: 'Online entrance assessment workshop',   jobType: 'Police officer',                      format: 'Virtual',   language: 'English',            time: '2:00 p.m.',  date: '2026-07-24', cancelled: false },
    ...
    { title: 'Séance questions-réponses – Québec',          city: 'Quebec City',     province: 'Quebec',                    tz: 'ET', eventType: 'Ask-a-recruiter',                       jobType: 'Police officer',                      format: 'Virtual',   language: 'French',             time: '3:00 p.m.',  date: '2026-08-12', cancelled: false },
    ...
    { title: 'National Online Fitness Assessment Workshop', city: '',                province: '',                          tz: 'ET', eventType: 'Police fitness assessment workshop',    jobType: 'Police officer',                      format: 'Virtual',   language: 'English',            time: '9:00 a.m.',  date: '2026-09-03', cancelled: false },
    ...
    { title: 'National Virtual Ask-a-Recruiter',            city: '',                province: '',                          tz: 'ET', eventType: 'Ask-a-recruiter',                       jobType: 'Telecommunications operator',         format: 'Virtual',   language: 'English',            time: '12:00 p.m.', date: '2026-09-29', cancelled: false },
    ...
    { title: 'National Online Ask-a-Recruiter – Telecom',  city: '',                province: '',                          tz: 'ET', eventType: 'Ask-a-recruiter',                       jobType: 'Telecommunications operator',         format: 'Virtual',   language: 'English and French', time: '2:00 p.m.',  date: '2026-10-20', cancelled: false },
  ...
  function formatDate(iso) {
    ...
    var label = d.toLocaleDateString('en-CA', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' });
    return label + ' at';
  }
