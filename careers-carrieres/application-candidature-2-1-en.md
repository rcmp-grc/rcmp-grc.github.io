...
<section id="s7">
  ...
  <p>There is a timer at the bottom of the page.</p>
   ...
   <h3>Part&nbsp;A – Verbal reasoning</h3>
     <p>Identify the word that best relates to the word provided. View this pair of words to understand how they relate to each other: Up - Down. Identify the word that makes the following words related in the same way.</p>
 <div class="panel panel-careers">
  <header class="panel-heading">
   <h4 class="panel-title">Sample question&nbsp;1</h4>
  </header>
