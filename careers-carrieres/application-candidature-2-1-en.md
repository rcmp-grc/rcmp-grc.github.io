...
<section id="s5">
  ...
  <ul>
   ...
   <h3>Part&nbsp;A – Rotating 2D&nbsp;shapes</h3>
     <p>You will be asked a series of questions related to 2D&nbsp;shapes. For each question, find the 2D shape that matches the shape displayed in the box. You have 3&nbsp;minutes to complete the set of questions.</p>
  <div class="panel panel-careers">
  <header class="panel-heading">
   <h4 class="panel-title">Sample question</h4>
  </header>
  <div class="panel-body">
 <p>Using the following image, match the shape displayed in the box with one of the 2D shapes (shapes A to E).</p> 
