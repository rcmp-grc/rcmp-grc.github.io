...
<nav aria-label="Étapes du processus de recrutement" class="gc-subway" data-sections-title="Étapes">
  ...
  <ul>
    ...
    <li><a class="active" href="application-candidature-2-fr.html">Exposé sur les carrières et évaluation d'entrée en ligne</a>
   <ul class="noline">
...
<section id="s2">
  ...
  <dl>
    <dt>Se préparer à l’évaluation</dt>
  ...
  <dl>
    <dt>Passer aux étapes suivantes</dt>
