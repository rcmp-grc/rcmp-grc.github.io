...
<nav aria-label="Application process steps" class="gc-subway" data-sections-title="Steps">
  ...
  <li><a href="application-candidature-2-1-en.html">RCMP Online Assessment Preparatory Guide</a></li>
    ...
    <li><a href="application-candidature-3-en.html">Submit the required forms and documents</a>
      <ul class="noline">
        <li><a class="active" href="application-candidature-3-1-en.html">How to complete the forms</a></li>
      </ul>
    </li>
...
<nav aria-labelledby="on-this-page">
  ...
  <ul>
    <li><a href="#s1">Vision and hearing exams</a></li>
    <li><a href="#s2">Security screening application</a></li>
    <li><a href="#s3">Additional guidance on completing forms</a></li>
  </ul>
</nav>

<section id="s1">
  <h2>Vision and hearing exams</h2>
  <p>You need to submit the following two forms to your Recruiting Analyst on request. The forms must be received before your medical assessment.</p>
  <ul>
    <li>Vision exam</li>
    <li>Hearing exam</li>
  </ul>
  ...
  <section id="s1-2">
    ...
    <section id="s1-2-1">
      ...
      <ul>
        <li>In your better ear: between 500 and 3,000&nbsp;Hz with no more than 30&nbsp;decibels of hearing loss</li>
        <li>In your worse ear: 3,000&nbsp;Hz with no more than 50&nbsp;decibels of hearing loss</li>
      </ul>
    </section>
  </section>
</section>
