...
<nav aria-labelledby="on-this-page-heading">
  ...
  <ul>
    ...
    <li><a href="#s3">Operational duties </a></li>
    <li><a href="#s4">Tiers of service </a></li>
    <li><a href="#s5">How to apply</a></li>
    <li><a href="#s6">Learn more</a></li>
  </ul>
</nav>
<section id="s1">
...
<section id="s3">
  ...
  <p>These vary by tier and from province to province, but can include: </p>
  <ul>
    <li>crime prevention and public safety education initiatives </li>
    <li>disaster assistance </li>
    <li>traffic control </li>
    <li>general duty operational patrols and attending calls for service with Regular Members </li>
  </ul>
</section>
<section id="s4">
<h2>Tiers of service </h2> 
