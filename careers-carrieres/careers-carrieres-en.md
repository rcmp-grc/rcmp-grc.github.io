...
<div id="careers-fullpage">
  <section class="fp-section" id="police-officer" style="background-image: url('/assets/img/hero-police-officer.jpg');">
    ...
    <div class="fp-content">
      ...
      <p class="header-description">Do you have what it takes to be a Mountie?</p><a class="btn btn-careers" href="#">More information <span class="wb-inv">about police officer careers</span></a>
    </div>
  </section>
