...
<section id="s1">
	...
	<ul>
		...
		<li>obtenir et exécuter des mandats;</li>
		<li>participer aux perquisitions;</li>
		<li>témoigner devant les tribunaux.</li>
	</ul>
</section>
<section id="s2">
	...
	<ul>
		<li>recueillir des éléments de preuve et les préserver</li>
		<li>vous présenter et témoigner devant les tribunaux</li>
		<li>appliquer vos compétences avancées et spécialisées, ainsi que votre expérience, et offrir des conseils et des recommandations relativement au <cite>Code criminel</cite></li>
	</ul>
	<p>Votre travail consistera entre autres à enquêter sur des crimes graves et hautement prioritaires, tels que&nbsp;:</p>
	<dl>
		<dt>Cybercriminalité</dt>
		<dd>
			<ul>
				<li>les vols en ligne de renseignements personnels identifiables</li>
				<li>les intrusions dans les réseaux, les rançongiciels et les dénis de service distribués (DDoS)</li>
				<li>les atteintes à la sécurité nationale</li>
				<li>les marchés illégaux</li>
			</ul>
		</dd>	
		<dt>Criminalité financière</dt>
		<dd>
			<ul>
				<li>la fraude grave</li>
				<li>les infractions graves liées aux marchés financiers</li>
				<li>le blanchiment d’argent</li>
				<li>les produits de la criminalité</li>
			</ul>
		</dd>
	</dl>
</section>
<section id="s3">
	...
	<ul>
		...
		<li>l’administration de serveurs, de réseaux ou de postes de travail</li>
	</ul>
	<p>Les enquêteurs criminels civils en criminalité financière possèdent des compétences, des connaissances et de l’expérience dans des domaines comme&nbsp;:</p>
	<ul>
		<li>la comptabilité</li>
		<li>l’administration des affaires</li>
		<li>le commerce</li>
		<li>les finances</li>
...
<section id="s5">
	...
	<p>Se joindre à la GRC offre de nombreux avantages, incluant&nbsp;:</p>
	<ul>
		<li>une semaine de travail de 37,5&nbsp;heures (des heures supplémentaires peuvent être requises dans certaines circonstances)</li>
		<li>un <a href="https://www.canada.ca/fr/secretariat-conseil-tresor/sujets/regime-retraite/renseignements-regime.html">régime de retraite</a> indexé</li>
		<li>des <a href="https://www.rssfp.ca/protections/">prestations de soins de santé</a> (médicaux et dentaires)</li>
		<li>trois semaines de congés payés dans l’année suivant l’embauche</li>
		<li>le remboursement des frais de permis et des cotisations professionnelles, s’il y a lieu</li>
		<li>un salaire concurrentiel&nbsp;:
            <ul>
                <li>taux en <a href="https://www.tbs-sct.canada.ca/agreements-conventions/view-visualiser-fra.aspx?id=31#toc45590245591">cybercriminalité</a> (TI-03 et TI-04)</li>
                <li>taux en <a href="https://www.tbs-sct.canada.ca/agreements-conventions/view-visualiser-fra.aspx?id=29#toc44206244208">criminalité financière</a> (CT-EAV-03 et CT-EAV-04)</li>
            </ul>
        </li>
		<li>le remboursement des dépenses de réinstallation, s’il y a lieu</li>
		<li>un programme de formation complet</li>
		<li>l’opportunité de contribuer à la sécurité de la population canadienne</li>
	</ul>
</section>
<section id="s6">
