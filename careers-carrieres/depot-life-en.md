...
<section id="s3">
	...
	<p>Dorms include:</p>
	<ul>
		<li>kitchen space with a fridge, microwave, sink and storage for food/supplies</li>
		<li>shared lounge area to support collaboration and downtime<ul>
				<li>these have televisions, space for studying or relaxing, and access to a secure RCMP computer</li>
			</ul>
		</li>
		<li>individual sleeping spaces (a “pit”)</li>
		<li>washroom and shower facilities include designated spaces for men and women, as well as gender-inclusive options</li>
		<li>dry-firing range, gun cleaning, ironing and polishing rooms</li>
	</ul>
	...
	<ul>
		...
		<li>closet and drawers</li>
		<li>secure storage</li>
		<li>supplied items, such as storage bins, hangers, linens, blankets, pillows, garbage containers, pen holders, and one electrical outlet</li>
	</ul>
</section>
...
<section id="s4">
	...
	<ul>
		<li><strong>The Division Mess (dining area):</strong>
			<ul>
				<li>provides a diverse, balanced menu that changes weekly to offer variety and fresh options</li>
				<li>most meals are prepared fresh</li>
				<li>cadets can choose options from the main steam-line, sandwich bar, salad bar and bakery</li>
				<li>meal accommodations can be arranged for a variety of dietary needs and preferences, including Kosher, Halal, gluten-free, vegetarian, vegan and other specific requirements</li>
			</ul>
		</li>
		<li><strong>Facilities</strong> include outdoor fitness equipment, multiple gyms, the Depot pool, disc golf course and during the winter months an outdoor rink</li>
		<li><strong>On-site parking</strong> is available for private vehicles. There is no cost for parking. There are no plugins for block heaters for EVs in the cadet parking lot.</li>
		<li><strong>On-site laundry</strong> is available. These operate with laundry cards for cadets to purchase and reload as needed</li>
	</ul>
</section>
...
<section id="s7">
	...
	<ul>
		...
		<li>Depot is home to a wide variety of wildlife. You will see a variety of birds, Canadian geese, jackrabbits, ducks and more</li>
	</ul>
</section>
