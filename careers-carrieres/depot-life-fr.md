...
<section id="s4">
  ...
  <dl>
    ...
    <dd>Celles-ci comprennent de l’équipement de conditionnement physique extérieur, plusieurs gymnases, une piscine, un parcours de disc-golf et une patinoire extérieure pendant l’hiver.</dd>
    <dt>Stationnement sur place</dt>
    <dd>Des espaces sont accessibles pour les véhicules personnels. Le stationnement est gratuit. Il n’y a pas de prises pour les chauffe-moteurs des véhicules électriques dans le stationnement des cadets.</dd>
    <dt>Buanderie sur place</dt>
    <dd>Les appareils fonctionnent avec des cartes de buanderie que les cadets peuvent acheter et recharger au besoin.</dd>
  </dl>
</section>
...
<section id="s5">
  ...
  <ul>
    ...
    <li><strong>les espaces spirituels</strong> comprennent la chapelle de la GRC, la salle de l’esprit autochtone et la salle de silence</li>
    <li><strong>le soutien aux troupes</strong> comprend des facilitateurs, des troupes jumelles, ainsi que des comités de mieux-être et de diversité</li>
    <li><strong>le Centre de ressources d’apprentissage</strong> favorise l’excellence académique et professionnelle en offrant des services de bibliothèque et des ressources de qualité aux cadets et aux employés</li>
  </ul>
</section>
...
<section id="s6">
  ...
  <dl>
    ...
    <dd>Les cadets peuvent utiliser leurs appareils personnels, de façon limitée, le soir et la fin de semaine. Les appareils ne sont pas permis pendant les examens.</dd>
    <dt>Exigences liées à l’horaire</dt>
    <dd>Le temps étant limité, il peut être difficile de rester en contact avec la famille et les amis.</dd>
  </dl>
</section>
