---
layout: careers
title: Programme d'expérience précadet diversifié et inclusif
date_modified: 2026-07-13
lang: fr
lang_url: dice-en.html
breadcrumbs:
...
<ul>
	...
	<li>Personnes d'ethnicité et groupes culturels divers</li>
...
<ul>
	...
	<li>des compétences qui vous aideront à vous préparer à poser votre candidature à une formation policière.</li>
</ul>
...
<section id="s2">
	<h2>Coûts</h2>
	<p>Les coûts du programme, y compris les frais de déplacement, de repas et d'hébergement et les coûts liés aux uniformes, sont assumés en totalité par la GRC.</p>
</section>
<section id="s3">
	<h2>Comment poser votre candidature</h2>
	<p>Pour obtenir plus d'information ou savoir comment poser votre candidature, envoyez un courriel au compte <a href="mailto:rcmp.dice-ecdi.grc@rcmp-grc.gc.ca">rcmp.dice-ecdi.grc@rcmp-grc.gc.ca</a>.</p>
</section>
<section id="s4">
