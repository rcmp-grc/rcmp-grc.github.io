---
layout: careers
title: Pass the Police Fitness Assessment
date_modified: 2026-07-13
lang: en
lang_url: epo-application-candidature-pe-3-fr.html
...
<nav aria-label="Application process steps" class="gc-subway" data-sections-title="Steps">
  ...
  <ul>
    ...
    <li><a class="active" href="epo-application-candidature-pe-3-en.html">Pass the Police Fitness Assessment</a></li>
...
<section id="s1">
    ...
    <p>Then you can schedule the police fitness assessment with your EPO coordinator.</p>
    <p>You will need to successfully complete the RCMP's police fitness assessment (PFA), field standard; which is performed in the general duty police uniform or the equivalent. The field version includes a 500-meter run, a lift/carry/run evacuation task and a medicine ball throw for distance.</p>
    <p>You will need to wear:</p>
    <ul>
        <li>general duty police uniform. If you don't have one, wear a t-shirt and pants that can comfortably accommodate a duty belt or weighted belt</li>
...
<nav aria-label="Pagination" class="rcmp-content-page rcmp-content-page--block" id="rcmp-content-page">
    <div class="rcmp-content-page__prev" id="mp-prev-wrap" style="display: block;">
        <a aria-label="Previous page: Applying as an Experienced Police Officer" class="rcmp-content-page__link" href="epo-application-candidature-pe-2-1-en.html" id="mp-prev">
            ...
            <span class="rcmp-content-page__link-label" id="mp-prev-label">Applying as an Experienced Police Officer</span></a>
    </div>
  <div class="rcmp-content-page__next" id="mp-next-wrap">
    <a aria-label="Next page: Complete a suitability interview" class="rcmp-content-page__link" href="epo-application-candidature-pe-4-en.html" id="mp-next">
      <span class="rcmp-content-page__title-row">
      ...
      <span class="rcmp-content-page__link-label" id="mp-next-label">Complete a suitability interview</span>
   </a>
  </div>
</nav>
<script>
