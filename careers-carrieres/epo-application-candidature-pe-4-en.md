...
lang: en
lang_url: epo-application-candidature-pe-4-fr.html
...
<nav aria-label="Application process steps" class="gc-subway" data-sections-title="Steps">
  ...
  <ul>
    ...
    <li><a class="active" href="epo-application-candidature-pe-4-en.html">Complete a suitability interview</a></li>
...
<section id="s1">
    <p>The interview will assess whether you possess the core competencies, core values, and traits required of an RCMP police officer. The interview could include behaviour-style questions that we recommend you answer using the STAR method: Situation, Task, Action and Result.</p>
    <p>After scheduling the interview, the EPO Coordinator will review two forms to prepare for the interview: the RMAQ and the Suitability Screening form.</p>
    <p>You would have already submitted the RMAQ and Suitability Screening form with your other forms earlier in the process.</p>
</section>
<nav aria-label="Pagination" class="rcmp-content-page rcmp-content-page--block" id="rcmp-content-page">
    <div class="rcmp-content-page__prev" id="mp-prev-wrap" style="display: block;">
        <a aria-label="Previous page: Pass the Police Fitness Assessment" class="rcmp-content-page__link" href="epo-application-candidature-pe-3-en.html" id="mp-prev">
            ...
            <span class="rcmp-content-page__link-label" id="mp-prev-label">Pass the Police Fitness Assessment</span></a>
    </div>
  <div class="rcmp-content-page__next" id="mp-next-wrap">
    <a aria-label="Next page: Undergo medical and psychological assessments" class="rcmp-content-page__link" href="epo-application-candidature-pe-5-en.html" id="mp-next">
      <span class="rcmp-content-page__title-row">
      ...
      <span class="rcmp-content-page__link-label" id="mp-next-label">Undergo medical and psychological assessments</span>
   </a>
  </div>
</nav>
<script>
