---
layout: careers
title: Évaluations médicale et psychologique
date_modified: 2026-07-13
lang: fr
lang_url: epo-application-candidature-pe-5-en.html
breadcrumbs:
...
<section id="s1">
  <p>Vous devrez vous soumettre à des évaluations de santé physique et psychologique auprès de médecins et de psychologues désignés par la GRC. La GRC assumera les coûts de ces évaluations. Si vous répondez aux exigences de ces évaluations, vous recevrez votre certificat d'aptitude physique et psychologique.</p>
</section>
<nav aria-label="Pagination" class="rcmp-content-page rcmp-content-page--block" id="rcmp-content-page">
  <div class="rcmp-content-page__previous" id="mp-previous-wrap">
    <a aria-label="Étape précédente&#160;: Entrevue d'admissibilité" class="rcmp-content-page__link" href="epo-application-candidature-pe-4-fr.html" id="mp-previous">
      ...
      <span class="rcmp-content-page__link-label" id="mp-previous-label">Entrevue d'admissibilité</span>
    </a>
  </div>
  <div class="rcmp-content-page__next" id="mp-next-wrap">
    <a aria-label="Étape suivante&#160;: Enquête sur le terrain et filtrage de sécurité" class="rcmp-content-page__link" href="epo-application-candidature-pe-6-fr.html" id="mp-next">
      <span class="rcmp-content-page__title-row">
      ...
      <span class="rcmp-content-page__link-label" id="mp-next-label">Enquête sur le terrain et filtrage de sécurité</span>
    </a>
  </div>
</nav>
<script>
