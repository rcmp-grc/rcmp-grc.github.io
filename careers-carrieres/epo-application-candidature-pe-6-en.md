---
layout: careers
title: Undergo a field investigation and security screening
date_modified: 2026-07-13
lang: en
lang_url: epo-application-candidature-pe-6-fr.html
...
<nav aria-label="Application process steps" class="gc-subway" data-sections-title="Steps">
  ...
  <ul>
    ...
    <li><a class="active" href="epo-application-candidature-pe-6-en.html">Undergo a field investigation and security screening</a></li>
    <li><a href="epo-application-candidature-pe-7-en.html">Complete the 3-week training</a></li>
  </ul>
</nav>

<section id="s1">
    <p>The final step in the application process is a field investigation and security screening. The RCMP will conduct a thorough investigation into your background to help assess your suitability. If successful, you will receive your security clearance.</p>
    <p>Your employers (previous and current) and references will be contacted as part of the background check. This check will help to verify your honesty.</p>
</section>
<nav aria-label="Pagination" class="rcmp-content-page rcmp-content-page--block" id="rcmp-content-page">
    <div class="rcmp-content-page__prev" id="mp-prev-wrap" style="display: block;">
        <a aria-label="Previous page: Undergo medical and psychological assessments" class="rcmp-content-page__link" href="epo-application-candidature-pe-5-en.html" id="mp-prev">
            ...
            <span class="rcmp-content-page__link-label" id="mp-prev-label">Undergo medical and psychological assessments</span></a>
    </div>
  <div class="rcmp-content-page__next" id="mp-next-wrap">
    <a aria-label="Next page: Complete the 3-week training" class="rcmp-content-page__link" href="epo-application-candidature-pe-7-en.html" id="mp-next">
      <span class="rcmp-content-page__title-row">
      ...
      <span class="rcmp-content-page__link-label" id="mp-next-label">Complete the 3-week training</span>
   </a>
  </div>
</nav>
<script>
