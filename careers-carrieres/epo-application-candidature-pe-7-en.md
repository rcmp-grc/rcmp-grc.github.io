---
layout: careers
title: Complete the 3-week training
date_modified: 2026-07-13
lang: en
lang_url: epo-application-candidature-pe-7-fr.html
...
<nav aria-label="Application process steps" class="gc-subway" data-sections-title="Steps">
  ...
  <ul>
    ...
    <li><a class="active" href="epo-application-candidature-pe-7-en.html">Complete the 3-week training</a></li>
  </ul>
</nav>
...
<nav aria-label="Pagination" class="rcmp-content-page rcmp-content-page--block" id="rcmp-content-page">
    <div class="rcmp-content-page__prev" id="mp-prev-wrap" style="display: block;">
        <a aria-label="Previous page: Undergo a field investigation and security screening" class="rcmp-content-page__link" href="epo-application-candidature-pe-6-en.html" id="mp-prev">
            ...
            <span class="rcmp-content-page__link-label" id="mp-prev-label">Undergo a field investigation and security screening</span></a>
    </div>
</nav>
<script>
