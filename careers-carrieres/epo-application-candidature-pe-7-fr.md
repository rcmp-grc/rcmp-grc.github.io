---
layout: careers
title: Formation de trois semaines
date_modified: 2026-07-13
lang: fr
lang_url: epo-application-candidature-pe-7-en.html
...
<nav aria-label="Étapes du processus de recrutement" class="gc-subway" data-sections-title="Étapes">
  ...
  <ul>
    ...
    <li><a class="active" href="epo-application-candidature-pe-7-fr.html">Formation de trois semaines</a></li>
  </ul>
</nav>
<section id="s1">
  <p>Une fois embauché(e), vous participerez à la formation de trois semaines du Programme des policiers d'expérience à l'École de la GRC (Division Dépôt), à Regina, en Saskatchewan, ou au Centre de formation de la région du Pacifique, à Chilliwack, en Colombie-Britannique, pour apprendre les procédures et les tactiques de la GRC.</p>
  <p>Après avoir terminé la formation, vous commencerez votre première affectation sous la supervision d'un moniteur de formation pratique.</p>
</section>
<nav aria-label="Pagination" class="rcmp-content-page rcmp-content-page--block" id="rcmp-content-page">
  <div class="rcmp-content-page__previous" id="mp-previous-wrap">
    <a aria-label="Étape précédente&#160;: Enquête sur le terrain et filtrage de sécurité" class="rcmp-content-page__link" href="epo-application-candidature-pe-5-fr.html" id="mp-previous">
      ...
      <span class="rcmp-content-page__link-label" id="mp-previous-label">Enquête sur le terrain et filtrage de sécurité</span>
    </a>
  </div>
</nav>
<script>
