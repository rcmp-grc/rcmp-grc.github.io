...
<section id="s1">
  ...
  leur formation. Les cadets dont le contrat de formation est résilié pour non-respect de ces valeurs ou qui quittent la
  GRC au cours de leur période de stage de deux ans devront rembourser la totalité des sommes reçues pendant leur
  formation à la Division Dépôt.</p>
</section>
<section id="s2">
  <h2>Taux de rémunération et avantages sociaux</h2>
  <p>Les taux de rémunération, les avantages sociaux et congés des policiers et policières de la GRC (dont le grade est inférieur à celui d’inspecteur) sont inscrits dans la <a href="https://www.canada.ca/fr/secretariat-conseil-tresor/sujets/remuneration/conventions-collectives/rm.html">convention collective des membres réguliers et des réservistes de la GRC</a>.</p>
  <section id="s2-1">
  ...
  <section id="s2-4">
    ...
    <ul>
      <li>Les policières(ères) ont accès sans frais aux prestations de soins de santé complémentaires (SSC).</li>
      <li>Le régime de soins de santé au travail est une protection supplémentaire que la GRC peut offrir, au cas par cas, à
    ses membres.</li>
      <li>Apprenez-en davantage sur le <a href="https://www.canada.ca/fr/secretariat-conseil-tresor/sujets/regimes-assurance/regimes/regime-soins-sante.html">Régime de soins de santé de la fonction publique</a> (RSSFP), auquel les personnes à
    votre charge peuvent être admissibles.</li>
      <li>Apprenez-en davantage sur le <a href="https://www.canada.ca/fr/secretariat-conseil-tresor/sujets/regimes-assurance/regimes/regime-soins-dentaires.html">Régime de soins dentaires de la fonction publique</a> (RSDFP), auquel les personnes à
    votre charge peuvent être admissibles.</li>
    </ul>
  </section>
</section>
