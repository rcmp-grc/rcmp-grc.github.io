...
<section id="s1">
  ...
  <ul>
    ...
    <li>sexual exploitation, violence, abuse or neglect towards children, vulnerable adults, or both</li>
    <li>terrorist activities</li>
    <li>participation with any organized criminal group</li>
    <li>benefiting from the trafficking, importing, unlawful manufacturing or unlawful cultivating of illegal drugs</li>
    <li>arson resulting in loss of life or substantial damage</li>
    <li>forcible confinement</li>
    <li>robbery</li>
    <li>any crime committed with a facial covering, a weapon, or both</li>
