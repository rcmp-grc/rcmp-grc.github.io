...
<section id="s1">
  ...
  <ul>
    ...
    <li>Exploitation sexuelle, actes de violence, mauvais traitements, négligence à l'endroit d'enfants ou d'adultes vulnérables</li>
    <li>Activités terroristes</li>
    <li>Participation aux activités d'un groupe criminel organisé</li>
    <li>Fait de tirer profit du trafic, de l'importation ou de la production ou de la culture illégales d'une drogue</li>
    <li>Incendie criminel entraînant la mort d'une personne ou des dommages considérables</li>
    <li>Séquestration</li>
    <li>Vol qualifié</li>
    <li>Tout crime commis à visage couvert ou à l'aide d'une arme</li>
    <li>Consommation de drogue ou de stéroïdes à des fins non médicales</li>
