...
<div class="well well-sm brdr-rds-0 mrgn-tp-lg">
  <div class="panel panel-default mrgn-bttm-0 brdr-rds-0">
    <div class="panel-body">
      <ul class="list-unstyled cnjnctn-type-or cnjnctn-md mrgn-tp-0">
        <li class="cnjnctn-col">
          <h2 class="mrgn-tp-0 h4">Access to Individual Web Services</h2>
          ...
          <div class="mrgn-tp-md">
            ...
            <p><a class="btn btn-primary btn-lg btn-block p-sm-3 mya" data-gc-analytics-customclick="CRA|ARC:Option 2 button click:CRA login button" href="https://ams-sga.cra-arc.gc.ca/gol-ged/awsc/amss/entry?target=login&amp;lang=en&amp;program=spoe&amp;idp=cms" rel="noreferrer noopener"><span class="h4"><span class="fas fa-sign-in-alt fa-fw fa-lg fa-pull-left mrgn-rght-sm"></span>CRA user ID and password<span class="wb-inv">: Sign in</span></span></a></p>
