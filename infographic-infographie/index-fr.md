  ...
  <figcaption class="mrgn-tp-md">
    <details class="mrgn-bttm-sm" id="infographic-description">
      ...
      <div class="mrgn-tp-md">
        <p>On parle de cybercrime lorsqu'un ordinateur ou une technologie numérique joue un rôle important dans la perpétration d'une infraction criminelle. Le <cite>Code criminel du Canada</cite> énonce les dispositions législatives qui s'appliquent aux crimes de ce genre&#160;:</p>
