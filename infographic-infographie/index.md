...
<figure>
  ...
  <figcaption>
    ...
    <details class="print-open">
      ...
      <p>© His Majesty the King in Right of Canada, as represented by the Royal Canadian Mounted Police, 2026</p>
      <p>Catalogue number PS64-274/2026E-PDF</p>
      <p>ISBN 978-0-660-99705-6</p>
    </details>
    <h2 class="h3">Downloadable files</h2><a class="btn btn-call-to-action" href="cyberchoices-infographic-eng.png">Download <span class="wb-inv">Is this a cybercrime?</span> infographic (PNG, 889 KB)</a> <!--<p><a href="">Available from <abbr>GC</abbr> Publications</a>.</p>-->
  </figcaption>
</figure>
