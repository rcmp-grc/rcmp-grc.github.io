...
<button type="button" class="btn btn-warning"><a href="#">Polar bear safety</a></button>	
</section>		
...
<section id="gc-contact" class="contact-us">
   ...
   <i class="fa-solid fa-phone fa-xl" style="color: hsl(214, 42%, 27%);"></i>&nbsp;613-555-0100</p>
...
<h4 class="news-contact-h4">British Columbia RCMP</h4>
  ...
  <i class="fa-solid fa-phone fa-xl" style="color: hsl(214, 42%, 27%);"></i>&nbsp;778-290-2929</p>	
	<section class="gc-followus">
<h4 class="mrgn-tp-lg wb-inv">Follow us</h4>
<ul class="list-inline">     
<li>
...
<li>
   ...
   <i class="fa-solid fa-phone fa-xl" style="color: hsl(214, 42%, 27%);"></i>&nbsp;604-555-5555</p>	
		<section class="gc-followus">
<h4 class="mrgn-tp-lg wb-inv">Follow us</h4>
<ul class="list-inline">     
<li>
