...
<script>
const users = [
  { title: '<div class="mrgn-lft-md"><strong><a href="https://rcmp.ca/en/news/2026/05/4352857"><abbr>RCMP</abbr> and <abbr>CBSA</abbr> dismantle crime group after nearly 250&nbsp;<abbr>kg</abbr> of cocaine is detected in shipping container in Halifax</a></strong></div>',  date: '<div class="mrgn-lft-md mrgn-tp-0">2026-05-07 | Federal Policing Central Region | News releases</div>', location: '<div class="mrgn-lft-md mrgn-tp-md mrgn-bttm-md"><strong>Newmarket, Ontario</strong></div>', description: '<div class="mrgn-lft-md">Canadian federal authorities dismantled an organized crime operation that imported 248.7&nbsp;<abbr>kg</abbr> of cocaine from the Dominican Republic.</div>' },
