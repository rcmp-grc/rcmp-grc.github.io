  ...
  function renderGrid(data, page) {
    ...
    slice.forEach(function (p) {
      ...
      li.innerHTML =
		  ...
		  '<dd>' + '<div class="wb-inv">' + t.updated + '</div>' + '<ol class="list-inline">' +  
		  '<li>' + '<i class="fa-solid fa-calendar-days"></i>&nbsp;' + p.updated + '&nbsp;&nbsp;' + '|' + '</li>' +  
		  ...
		  '<dd>' + '<div class="wb-inv">' + t.category + '</div>' + p.category + '</dd>' +
		  '</dl>';
      grid.appendChild(li);
    });
  }
