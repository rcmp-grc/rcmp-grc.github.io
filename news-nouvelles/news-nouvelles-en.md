  ...
  function renderGrid(data, page) {
    ...
    slice.forEach(function (p) {
      ...
      li.innerHTML =
		  ...
		  '<dd>' + '<div class="wb-inv">' + t.updated + '</div>' + '<ol class="list-inline">' +  '<li>' + '<i class="fa-solid fa-calendar-days"></i>&nbsp;' + p.updated + '&nbsp;' + '&nbsp;' + '|' + '</li>' + '<div class="wb-inv">' + t.region + '</div>' + '<li>' + p.region + '&nbsp;' + '&nbsp;' + '|' + '</li>' + '<div class="wb-inv">' + t.category + '</div>' + '<li>' + p.category + '</li>' + '</ol>' + '</dd>' +
