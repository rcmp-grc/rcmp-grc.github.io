...
<script>
const users = [
  { title: '<strong><a href="https://rcmp.ca/en/news/2026/05/4352857"><abbr>RCMP</abbr> and <abbr>CBSA</abbr> dismantle crime group after nearly 250&nbsp;<abbr>kg</abbr> of cocaine is detected in shipping container in Halifax</a></strong><br>',  date: '2026-05-07 | Federal Policing Central Region | News releases<br><br>', location: '<strong>Newmarket, Ontario</strong><br><br>', description: 'Canadian federal authorities dismantled an organized crime operation that imported 248.7&nbsp;<abbr>kg</abbr> of cocaine from the Dominican Republic.' },
