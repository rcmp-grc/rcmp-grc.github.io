...
<div id="cn-page">
  ...
  <div class="row mrgn-bttm-md">
    <div class="col-md-10 col-md-offset-1">
      <figure id="cn-hero">
        <img alt="Le gendarme SpongeBob SquarePants de la GRC agenouillé dans une rue ensoleillée pour saluer Gary l'escargot, entouré de résidents souriants de Bikini Bottom" class="img-responsive" src="https://dummyimage.com/1200x600/000/fff">
        <figcaption>
          <strong>Le gendarme SpongeBob SquarePants avec Gary peu avant leurs retrouvailles — Bikini Bottom, mai 2026</strong> Des résidents se sont rassemblés devant le Krusty Krab pour souligner le retour sécuritaire de Gary à la maison. Photo : Détachement de Bikini Bottom / GRC
        </figcaption>
      </figure>
    </div>
  </div>
      ...
      <div id="cn-body">
        <div aria-label="Faits saillants" class="cn-infobox" role="note">
          ...
          <ul>
            ...
            <li>Des résidents se sont rassemblés devant le Krusty Krab pour célébrer son retour</li>
            <li>Le programme de marche communautaire du détachement est en place depuis trois ans</li>
          </ul>
        </div>
        <p>Tout a commencé par un petit miaulement discret.</p>
        <p>Par une douce matinée de mai, le gendarme SpongeBob SquarePants du détachement de la GRC de Bikini Bottom terminait une marche communautaire de routine lorsqu'il a remarqué un petit escargot à coquille argentée avançant lentement sur le trottoir devant le Krusty Krab. L'escargot semblait calme, mais visiblement loin de chez lui.</p>
        <p>L'escargot, plus tard identifié comme étant Gary, s'était éloigné de sa résidence située sur la rue Conch au cours de la nuit précédente. Sa propriétaire, Mme Pearl Krabs, une ancienne éleveuse de méduses maintenant retraitée, avait passé plusieurs heures à parcourir le quartier avant de signaler la disparition de son animal au détachement plus tôt ce matin-là.</p>
        ...
        <p>Pour plusieurs résidents, cette histoire dépassait le simple retour d'un animal de compagnie à la maison. Elle témoignait aussi des liens de confiance qui existent dans le quartier et qui ont permis à tout le monde de réagir rapidement.</p>
        <p>Les voisins reconnaissaient Gary. Les résidents connaissaient le gendarme qui faisait sa tournée ce matin-là. Les gens se sont arrêtés spontanément pour aider. Dans un monde souvent pressé, ces petits gestes de proximité ont parfois plus d'importance qu'on le pense.</p>
        <figure class="cn-inline-figure">
          <img alt="Des résidents de la rue Conch rassemblés à l'extérieur par une matinée ensoleillée, discutant avec un agent de la GRC et tenant des pancartes de bienvenue pour Gary l'escargot" class="img-responsive" src="https://dummyimage.com/800x450/000/fff">
          <figcaption>
            Des résidents de la rue Conch se sont réunis pour souhaiter la bienvenue à Gary. Plus de trente voisins ont participé à cette célébration improvisée. Photo : Détachement de Bikini Bottom / GRC
          </figcaption>
        </figure>
        ...
        <p>Pour le gendarme SquarePants, il s'agissait simplement de faire son travail.</p>
