  ...
  <div class="col-md-3 col-sm-4" id="mp-sidebar">
    <aside aria-labelledby="mp-filters-heading" id="mp-filters">
      ...
      <details class="wp-filter-group">
        <summary class="wp-filter-group-toggle">
          <i class="fa-solid fa-chevron-down wp-filter-chevron" aria-hidden="true"></i>
          <span class="wp-filter-summary-label">Location</span>
        </summary>
        <fieldset>
          <legend class="wb-inv">Location</legend>
          <details class="mp-province-group">
            <summary class="mp-province-toggle">
              <i class="fa-solid fa-chevron-down wp-filter-chevron" aria-hidden="true"></i>
              <span>Alberta</span>
            </summary>
            <div class="mp-cities">
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="calgary"><span class="cb-text">Calgary</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="edmonton"><span class="cb-text">Edmonton</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="lethbridge"><span class="cb-text">Lethbridge</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="red-deer"><span class="cb-text">Red Deer</span><span class="wp-filter-badge">0</span></label></div>
            </div>
          </details>
          <details class="mp-province-group">
            <summary class="mp-province-toggle">
            ...
            <div class="mp-cities">
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="kelowna"><span class="cb-text">Kelowna</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="prince-george"><span class="cb-text">Prince George</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="surrey"><span class="cb-text">Surrey</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="vancouver"><span class="cb-text">Vancouver</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="victoria"><span class="cb-text">Victoria</span><span class="wp-filter-badge">0</span></label></div>
            </div>
          </details>
          <details class="mp-province-group">
            <summary class="mp-province-toggle">
            ...
            <div class="mp-cities">
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="brandon"><span class="cb-text">Brandon</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="winnipeg"><span class="cb-text">Winnipeg</span><span class="wp-filter-badge">0</span></label></div>
            </div>
          </details>
          <details class="mp-province-group">
            <summary class="mp-province-toggle">
            ...
            <div class="mp-cities">
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="fredericton"><span class="cb-text">Fredericton</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="moncton"><span class="cb-text">Moncton</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="saint-john"><span class="cb-text">Saint John</span><span class="wp-filter-badge">0</span></label></div>
            </div>
          </details>
          <details class="mp-province-group">
            <summary class="mp-province-toggle">
            ...
            <div class="mp-cities">
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="corner-brook"><span class="cb-text">Corner Brook</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="st-johns"><span class="cb-text">St. John's</span><span class="wp-filter-badge">0</span></label></div>
            </div>
          </details>
          <details class="mp-province-group">
            <summary class="mp-province-toggle">
            ...
            <div class="mp-cities">
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="yellowknife"><span class="cb-text">Yellowknife</span><span class="wp-filter-badge">0</span></label></div>
            </div>
          </details>
          <details class="mp-province-group">
            <summary class="mp-province-toggle">
            ...
            <div class="mp-cities">
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="cape-breton"><span class="cb-text">Cape Breton</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="dartmouth"><span class="cb-text">Dartmouth</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="halifax"><span class="cb-text">Halifax</span><span class="wp-filter-badge">0</span></label></div>
            </div>
          </details>
          <details class="mp-province-group">
            <summary class="mp-province-toggle">
            ...
            <div class="mp-cities">
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="iqaluit"><span class="cb-text">Iqaluit</span><span class="wp-filter-badge">0</span></label></div>
            </div>
          </details>
          <details class="mp-province-group">
            <summary class="mp-province-toggle">
            ...
            <div class="mp-cities">
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="hamilton"><span class="cb-text">Hamilton</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="london-on"><span class="cb-text">London</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="ottawa"><span class="cb-text">Ottawa</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="toronto"><span class="cb-text">Toronto</span><span class="wp-filter-badge">0</span></label></div>
            </div>
          </details>
          <details class="mp-province-group">
            <summary class="mp-province-toggle">
            ...
            <div class="mp-cities">
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="charlottetown"><span class="cb-text">Charlottetown</span><span class="wp-filter-badge">0</span></label></div>
            </div>
          </details>
          <details class="mp-province-group">
            <summary class="mp-province-toggle">
            ...
            <div class="mp-cities">
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="gatineau"><span class="cb-text">Gatineau</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="montreal"><span class="cb-text">Montréal</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="quebec-city"><span class="cb-text">Québec City</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="sherbrooke"><span class="cb-text">Sherbrooke</span><span class="wp-filter-badge">0</span></label></div>
            </div>
          </details>
          <details class="mp-province-group">
            <summary class="mp-province-toggle">
            ...
            <div class="mp-cities">
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="moose-jaw"><span class="cb-text">Moose Jaw</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="prince-albert"><span class="cb-text">Prince Albert</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="regina"><span class="cb-text">Regina</span><span class="wp-filter-badge">0</span></label></div>
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="saskatoon"><span class="cb-text">Saskatoon</span><span class="wp-filter-badge">0</span></label></div>
            </div>
          </details>
          <details class="mp-province-group">
            <summary class="mp-province-toggle">
            ...
            <div class="mp-cities">
              <div class="checkbox"><label><input data-filter="location" type="checkbox" value="whitehorse"><span class="cb-text">Whitehorse</span><span class="wp-filter-badge">0</span></label></div>
            </div>
          </details>
        </fieldset>
      </details>
